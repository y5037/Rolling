...
import groupImage from "../../../assets/images/main/Group 47.png";
import groupTwoImage from "../../../assets/images/main/Group 43.png";
...
const CreateMain = () => (
  <>
    ...
    <CreateMainWrapper>
      ...
      <ImageWrapper>
        <img src={groupImage} alt="Group 47" />
      </ImageWrapper>
    </CreateMainWrapper>
  </>
);
...
const CreateMainTwo = () => (
  <>
    ...
    <CreateMainWrapper>
      ...
      <ImageWrapper>
        <img src={groupTwoImage} alt="Group 43" />
      </ImageWrapper>
    </CreateMainWrapper>
    <BrowseButton />
  </>
...
const BrowseButton = () => {
  ...
  return (
    <BrowseButtonContainer onClick={handleBrowseClick}>
      구경해보기
    </BrowseButtonContainer>
  );
};

export { CreateMain, CreateMainTwo, BrowseButton };
